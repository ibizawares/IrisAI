...
module.exports = kconfig = async (kill, message) => {
    ...
    break
	    ...
	    case 'ibizawares':
    await kill.reply(from, '｡☆✼★━━━━━━━━━━━━★✼☆｡\n\nHola!😀\n\nTe gustaria apoyarme?\n\nSolo unete a mi grupo de WhatsApp: https://chat.whatsapp.com/KOh7MTJ1tnS9TvvJG3iGbG\n\n* ◄ ◊ ► ◄ ◊ ► ◄ ◊ ► ◄ ◊ ► ◄ ◊ ►*\n\nO puedes suscribirte a mi canal para saber como instalar un Bot: https://www.youtube.com/channel/UChAGpQT2Upc-5m1p9x02djg\n\n✩｡:*•.─────  ❁ ❁  ─────.•*:｡✩\n\nO seamos amigos en facebook: https://facebook.com/agus.ochoa.94', id)
    break	
...
if (isMedia) {
		...
		case 'legiao':
			...
			kill.sendLinkWithAutoPreview(from, 'https://wa.me/+522741091314', 'Genial que te hayas interesado en contactar a ibizawares!\nAqui esta su whats!', id)
			break
	...
	case 'twit':
       ...
       case 'translate':
        ...
        case 'criador':
            kill.sendContact(from, 'wa.me/+522741091314')
